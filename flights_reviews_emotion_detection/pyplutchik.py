    ...
    if not iterable:
        if show_coordinates:
            ...
            _petal_spine_emotion(ax=ax, emotion=emotion, emotion_score=emotion_score,
                                 ...
                                 offset=.15)
        # Draw petal
        _petal_shape_emotion(ax, emotion_score, color, angle, font, fontweight, fontsize, height_width_ratio=height_width_ratio, highlight=highlight, will_circle=False,
                             normalize=normalize)
        # Draw border
        ...
        # Draw petal
        petal_shape = _petal_shape_emotion(ax, length, color, angle, font, fontweight, fontsize, height_width_ratio=height_width_ratio, highlight=highlight, will_circle=True,
                                           normalize=normalize)
...
def _draw_dyad_petal(ax, dyad, dyad_score, font, fontweight, fontsize, show_coordinates, height_width_ratio, offset=.15, normalize=False):
    ...
    *normalize*:
    ...
    ax = _petal_shape_dyad(ax, dyad_score, colorA, colorB, angle, font, fontweight, fontsize, height_width_ratio=height_width_ratio, highlight='all', will_circle=False,
                           normalize=normalize)
    # Draw border
